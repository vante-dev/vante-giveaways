 ...
 * @property {string} [giveawayEndedButton='Go to the giveaway'] Displayed under the giveaway ended message when the giveaway has ended.
 ...
 * @property {string} [drawing='Drawing: {timestamp}'] Displayed below "inviteToParticipate" in the giveaway embed: "{timestamp-relative} ({timestamp-default})", "{timestamp-relative}" will dynamically represent the time remaining, while "{timestamp-default}" will automatically reflect the original timestamp.
 ...
 * @property {string} [default.buttonEmoji='🎉'] The emoji to participate in giveaways.
 * @property {number} [default.buttonStyle='Discord.ButtonStyle.Secondary'] The emoji to participate in giveaways.
 ...
 * @property {string|MessageObject} [messages.congrat=':tada: New winner(s): {winners}! Congratulations, you won **{this.prize}**!'] The message used if there are new winners.
